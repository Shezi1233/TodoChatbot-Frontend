    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 selection:bg-primary selection:text-black">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-2">Enter your details to access your workspace</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label htmlFor="password" className="text-[10px] uppercase tracking-widest font-black text-white/30">
                  Password
                </label>
                <a href="#" className="text-[10px] uppercase tracking-widest font-black text-primary hover:underline">Forgot?</a>
              </div>
              <div className="relative">
            ...
            <Button
              type="submit"
              variant="yellow"
              className="w-full py-6 rounded-xl shadow-[0_0_20px_rgba(255,215,0,0.1)] active:scale-[0.98] transition-transform"
              disabled={isLoading}
            >
